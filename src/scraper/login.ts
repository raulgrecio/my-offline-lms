...
export async function interactiveLogin(
  ...
  const saveSession = async () => {
    console.log("\n[Auth] Guardando estado de la sesión y cookies... (Automático / Manual)");
    try {
  ...
  // Autoguardado silencioso cada 15 minutos (900,000 ms) para evitar que yt-dlp/downloader fallen en descargas largas
