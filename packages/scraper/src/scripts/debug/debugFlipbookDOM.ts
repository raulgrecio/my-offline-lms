...
async function run() {
  ...
  console.log("Navigating to viewer:", courseUrl);
  ...
  if (iframeSrc) {
      console.log("Navigating into iframe...");
      ...
      console.log("Extracted max page count:", maxPage);
      ...
      console.log("Sample image SRC from thumbnails:", imgBaseUrl);
  }
