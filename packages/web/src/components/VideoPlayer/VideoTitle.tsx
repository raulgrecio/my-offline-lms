...
export default function VideoTitle({ title, isVisible }: VideoTitleProps) {
  return (
    <div
      className={`absolute top-0 left-0 right-0 p-6 transition-opacity duration-500 pointer-events-none z-20 bg-linear-to-b from-black/40 to-transparent ${isVisible ? 'opacity-100' : 'opacity-0'}`}
    >
